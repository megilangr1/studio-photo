                ...
                <tr>
                  <td class="content-cell"
                    ...
                    <h2
                      ...
                      Halo {{ $data['pelanggan']['nama_lengkap'] }}</h2>
                    <p
                      ...
                      Silahkan Selesaikan Registrasi Akun Anda :<br><br></p>
                    {{-- <h3
                      ...
                      Nama Penerima : pelanggan<br>
                      Alamat Penerima : jalan pgr<br>
                      Total Harga Pemesanan : 5047000<br>
                      Tanggal Pemesanan : 2021-02-22 03:30:29<br>
                      Status :
                    </h3> --}}
                    <p
                      style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                      Klik Tombol di-bawah untuk melakukan verifikasi e-mail agar dapat melakukan booking :</p>
                ...
                <tr>
                  <td class="content-cell" align="center"
                    ...
                    <p
                      ...
                      © 2022 Afternoon Photo Studio. All rights reserved.</p>
                  </td>
                </tr>
              </table>
            </td>
