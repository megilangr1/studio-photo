      ...
      <table class="table table-bordered text-xs">
        <thead>
          <tr>
            ...
            <th class="align-middle">Asal / Tujuan</th>
            <th class="align-middle text-right" width="20%">Nominal</th>
            <th class="align-middle text-right" width="20%">Keterangan</th>
          </tr>
        </thead>
        <tbody>
          @forelse ($data as $item)
            <tr>
              ...
              <td class="align-middle text-center p-2">{{ date('d/m/Y', strtotime($item['tanggal_data'])) }}</td>
              ...
              <td class="align-middle p-2">{{ $item['asal_uang'] }}</td>
              <td class="align-middle p-2 text-nowrap font-weight-bold" style="text-align: right !important;">
                <div style="float: left;">Rp. </div>{{ number_format($item['nominal'], 0, ',', '.') }}
              </td>
              <td class="align-middle text-center p-2">{{ $item['keterangan'] != null ? $item['keterangan']:'-' }}</td>
            </tr>
          @empty
            <tr>
