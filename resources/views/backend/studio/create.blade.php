...
<div class="row">
  <div class="col-12">
    <div class="card card-outline card-primary">
      ...
      <div class="card-body">
        <form action="{{ route('backend.studio.store') }}" method="post">
          @csrf
          <div class="row">
            <div class="col-md-5">
              <div class="form-group">
                <label for="nama_studio">Nama Studio : </label>
                <input type="text" name="nama_studio" id="nama_studio" class="form-control {{ $errors->has('nama_studio') ? 'is-invalid':'' }}" value="{{ old('nama_studio') }}" placeholder="Masukan Nama Studio..." required autofocus>
